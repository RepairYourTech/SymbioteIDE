...
fn golden_request_and_response_remain_stable() {
    let fixture = r#"{"version":{"major":1,"minor":30},"correlation_id":"request-a","command_id":"command-a","operation":{"kind":"get_project","project_id":"project-a"}}"#;
    ...
    assert_eq!(
        ...
        json!({"version":{"major":1,"minor": 30},"correlation_id":"request-a","result":{"Err":{"code":"not_found","message":"resource not found"}}})
    );
}
