...
```sh
printf '%s\n' '{"version":{"major":1,"minor":0},"correlation_id":"health-request","command_id":"health-command","operation":{"kind":"health"}}' | target/debug/symbiote --state-dir /absolute/private/state-directory request
```
