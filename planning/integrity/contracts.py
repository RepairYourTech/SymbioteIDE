...
HELD = {
    ...
    "runtime-sdk.md": ("symbiote-runtime-sdk", "the_document_names_every_rule_the_suite_runs"),
...
NOT_HELD = {
    ...
    "protocol.v1.schema.json": "generated by the protocol schema example from the wire types' own derives, and compared byte for byte with the case beside the crate",
