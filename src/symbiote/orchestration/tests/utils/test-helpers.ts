...
import { ModelProfile, AITask, TaskResult, ProviderType } from '../../types';
...
export function createFixtures(): {
  ...
  return {
    models: [
      createMockModel({ id: 'gpt-4', provider: ProviderType.OpenAI, name: 'GPT-4' }),
      createMockModel({ id: 'claude-3', provider: ProviderType.Anthropic, name: 'Claude 3' }),
      createMockModel({ id: 'gemini-pro', provider: ProviderType.Google, name: 'Gemini Pro' })
    ],
    tasks: [
