...
export type EntityType = 'code_file' | 'function' | 'class' | 'module' | 'documentation' | 'issue' | 'commit' | 'developer' | 'concept' | 'pattern' | 'dependency';
...
export type RelationType = 'imports' | 'exports' | 'calls' | 'implements' | 'extends' | 'references' | 'authored_by' | 'related_to' | 'depends_on' | 'similar_to';
